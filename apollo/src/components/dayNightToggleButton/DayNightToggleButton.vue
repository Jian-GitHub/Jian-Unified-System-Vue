...
.container .daytime-background:nth-child(2) {
  top: -20em;
  left: -20em;
  width: 110em;
  height: 110em;
...
.container .daytime-background:nth-child(3) {
  top: -32.5em;
  left: -17.5em;
  width: 135em;
  height: 135em;
...
.container .daytime-background:nth-child(4) {
  top: -45em;
  left: -15em;
  width: 160em;
  height: 160em;
...
.container .components .main-button:hover ~ .daytime-background:nth-child(2) {
  -webkit-transform: translateX(10em);
  -moz-transform: translateX(10em);
  -o-transform: translateX(10em);
  -ms-transform: translateX(10em);
...
.container .components .main-button:hover ~ .daytime-background:nth-child(3) {
...
.container .components .main-button:hover ~ .daytime-background:nth-child(4) {
...
[data-theme="dark"] .container .daytime-background:nth-child(2) {
  -webkit-transform: translateX(110em);
  -moz-transform: translateX(110em);
  -o-transform: translateX(110em);
  -ms-transform: translateX(110em);
...
[data-theme="dark"] .container .daytime-background:nth-child(3) {
...
[data-theme="dark"] .container .daytime-background:nth-child(4) {
