...
import WhiteCard from "./views/WhiteCard.vue";
import ImgCard from "./views/ImgCard.vue";
// WhatsApp
...
import GlassSurface from "./GlassSurface/GlassSurface.vue";
import GradualBlur from "./GradualBlur/GradualBlur.vue";
