...
.theme-toggle { position:relative; display:inline-flex; align-items:center; justify-content:center; flex-shrink:0; width:50px; height:44px; padding:0; border:0; border-radius:7px; background:transparent; cursor:pointer; }
.theme-toggle:focus-visible { outline:2px solid var(--heph-pine); outline-offset:2px; }
.day-night-toggle-container { display:block; flex-shrink:0; font-size:.25px; }
</style>
